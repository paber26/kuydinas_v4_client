              ...
              <div class="project-icon-selected">
                <div class="listing-social-link pb-lg-0 pb-xs-2">
                  <div class="icon-list-social d-flex">
                    <a
                      class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center ms-xl-20 me-20 active"
                      href="#"
                    >
                      <img class="svg" src="img/svg/grid.svg" alt="grid"
                    /></a>
                    <a
                      class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center"
                      href="project-table.html"
                    >
                      <img class="svg" src="img/svg/list.svg" alt="list"
                    /></a>
                  </div>
                </div>
              </div>
        ...
        <div class="tab-content mt-25" id="ap-tabContent">
          ...
          >
                  ...
                  <div class="border-bottom px-30">
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          class="my-sm-0 my-2 media-badge text-uppercase color-white bg-secondary"
                          >early</span
                        >
                      </div>
                      <div class="mt-n15">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div
                  class="d-flex justify-content-md-end justify-content-center mt-1 mb-30"
                >
                  <nav class="dm-page">
...
export default {
  ...
  mounted() {
    axios
      ...
      .then((response) => {
        this.pembahasans = response.data;
