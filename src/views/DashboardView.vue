    ...
    <div class="demo2 mb-25 t-thead-bg">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-12 mb-xxl-45 mb-md-50 mb-30">
            <div class="card banner-feature--13 d-flex">
              <div
                class="d-flex align-items-center flex-sm-nowrap flex-wrap text-sm-start text-center"
              >
                <div class="card-body">
                  <h2 class="banner-feature__heading">Halo {{ user.name }}!</h2>
                  ...
                  >
                    <button
                      class="banner-feature__btn btn color-primary btn-md px-20 bg-white radius-xs fs-15"
                      type="button"
                    >
                      Ikuti Try Out
                    </button>
                ...
                <div class="banner-feature__shape">
                  <img src="img/svg/objects.svg" alt="img" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xxl-3 col-sm-6 col-ssm-12 mb-30">
            <!-- Card 2 -->
            <div
              class="ap-po-details ap-po-details--ticket radius-xl d-flex justify-content-between"
            >
          ...
          <div class="col-12">
            <div class="support-ticket-system">
              <div
                class="breadcrumb-main breadcrumb-main--ticket justify-content-sm-between"
              >
                <div
                    ...
                    <tbody>
                          ...
                          <div class="d-flex">
                            ...
                            >
                              <a
                                ...
                                style="
                                  background-image: url('img/tm6.png');
                      ...
                      <tr>
                          ...
                          <div class="d-flex">
                            ...
                            >
                              <a
                                ...
                                class="profile-image rounded-circle d-block m-0"
                                style="
                                  background-image: url('img/tm1.png');
                                  background-size: cover;
                                "
                              ></a>
                            </div>
                        ...
                        <td>
                          <div class="userDatatable-content d-inline-block">
                            <span
                              class="bg-opacity-warning color-warning userDatatable-content-status active"
                              >pending</span
                            >
                          </div>
                        </td>
                          ...
                          <div class="d-flex">
                            ...
                            >
                              <a
                                ...
                                class="profile-image rounded-circle d-block m-0"
                                style="
                                  background-image: url('img/tm3.png');
                                  background-size: cover;
                                "
                              ></a>
                            </div>
                          ...
                          <div class="d-flex">
                            ...
                            >
                              <a
                                ...
                                class="profile-image rounded-circle d-block m-0"
                                style="
                                  background-image: url('img/tm4.png');
                                  background-size: cover;
                                "
                              ></a>
                            </div>
          ...
          <div class="col-lg-12 mb-25">
            <div class="card border-0 px-25">
              <div class="card-header px-0 border-0">
                <h6 class="py-3">Sedang mengerjakan</h6>
              </div>
                        ...
                        <table class="table table--default table-borderless">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="text-center">$38,536</td>
                              <td class="text-center">Smart Phone</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
